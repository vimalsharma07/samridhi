...
<section class="relative py-24 md:py-32 bg-gradient-to-br from-[#1E3A8A] via-[#1D3A8F] to-[#152a6b] text-white overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <p class="text-[#F48C06] font-semibold uppercase tracking-[0.2em] text-sm scroll-reveal">Quality</p>
        <h1 class="mt-4 text-4xl md:text-5xl lg:text-6xl font-bold max-w-3xl scroll-reveal animation-delay-100">Excellence in Every Step</h1>
        <p class="mt-6 text-lg md:text-xl text-white/90 max-w-2xl scroll-reveal animation-delay-200">Rigorous quality control, international standards, and a commitment to delivering the finest steel pipes and tubes.</p>
    </div>
</section>
