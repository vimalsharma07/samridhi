        ...
        <aside class="w-64 bg-[#1E3A8A] text-white flex-shrink-0 fixed inset-y-0 left-0 z-40 transform transition-transform duration-200 lg:translate-x-0 -translate-x-full">
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                    ...
                    <a href="{{ route('admin.products.index') }}" class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-white/10 transition-colors {{ request()->routeIs('admin.products.*') ? 'active' : '' }}">
