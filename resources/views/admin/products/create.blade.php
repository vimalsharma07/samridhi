...
<form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data"
    ...
    <div>
        ...
        <p class="mt-1 text-sm text-gray-500">Shown below title on the product detail page</p>
    </div>
    ...
    <div>
        ...
        <input type="file" name="gallery_images[]" id="gallery_images" accept="image/*" multiple
            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1E3A8A] focus:border-transparent">
        <p class="mt-1 text-sm text-gray-500">Multiple images for the product detail page gallery (max 2MB each)</p>
    </div>
