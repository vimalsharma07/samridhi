...
@section('content')
{{-- banner-products-listing.png — /products (all categories) --}}
<section class="relative min-h-[260px] sm:min-h-[300px] md:min-h-[340px] flex items-center overflow-hidden text-white">
    <div class="absolute inset-0 bg-[#1a1a1a]">
        <img src="{{ asset('images/banner-products-listing.png') }}" alt="Steel products warehouse" class="absolute inset-0 w-full h-full object-cover object-center" fetchpriority="high" decoding="async">
    </div>
    <div class="absolute inset-0 bg-gradient-to-r from-black/80 via-black/50 to-black/25 pointer-events-none" aria-hidden="true"></div>
    ...
    <div class="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 md:py-20">
        <div class="max-w-3xl">
            ...
            <h1 class="mt-4 text-3xl sm:text-4xl md:text-5xl font-bold leading-tight drop-shadow-[0_2px_20px_rgba(0,0,0,0.5)]">Our Products</h1>
            <p class="mt-4 text-base sm:text-lg md:text-xl text-white/95 max-w-2xl drop-shadow-md border-l-4 border-[#E85D04]/90 pl-5">
                Comprehensive range of steel pipes, tubes, coils &amp; structures
            </p>
        </div>
    </div>
</section>
